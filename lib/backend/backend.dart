...
import 'schema/patient_doctor_record.dart';
...
export 'schema/patient_doctor_record.dart';
...
/// Functions to query PatientDoctorRecords (as a Stream and as a Future).
Future<int> queryPatientDoctorRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PatientDoctorRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PatientDoctorRecord>> queryPatientDoctorRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      PatientDoctorRecord.collection,
      PatientDoctorRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<PatientDoctorRecord>> queryPatientDoctorRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
